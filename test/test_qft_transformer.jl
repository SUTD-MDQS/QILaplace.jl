...
@testset "qft_transformer.jl: zip down algorithm correctness" begin
    @testset "Zip Down: Compression Within Tolerance" begin
        ...
        for n in 3:5
            ...
            cutoff = 1e-12
            maxdim = 100
            mpo_compressed, final_oc = zip_down_mpos(
                mpo_zipped, new_oc; cutoff=cutoff, maxdim=maxdim
            )
    ...
    @testset "Zip Down: Bond Dimension Reduction" begin
        ...
        for n in 3:5
            ...
            cutoff = 1e-12
            maxdim = 100
            mpo_compressed, _ = zip_down_mpos(
                mpo_zipped, new_oc; cutoff=cutoff, maxdim=maxdim
            )
    ...
    @testset "Zip Down: Identity Test with Apply" begin
        ...
        err =
            LinearAlgebra.norm(arr_compressed - arr_original) /
            LinearAlgebra.norm(arr_original)
        @test err < 1e-12
