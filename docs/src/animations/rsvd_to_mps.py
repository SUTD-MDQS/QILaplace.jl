...
class RSVDRMPSConversion(Scene):
    def construct(self):
        ...
        s_mid_target = make_s_node(BOND_COLOR, "S_2").move_to(at_x(0))
        ...
        s_L_target = make_s_node(BOND_COLOR, "S_1").move_to(at_x(-2.4))
        s_L = s_L_target.copy().stretch(S_SQUASH_Y, dim=1)
        self.add(s_L)

        s_R_target = make_s_node(BOND_COLOR, "S_3").move_to(at_x(2.4))
